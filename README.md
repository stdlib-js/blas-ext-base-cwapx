...
```javascript
import cwapx from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-cwapx@deno/mod.js';
```
...
[@stdlib/blas/ext/base/capx]: https://github.com/stdlib-js/blas-ext-base-capx/tree/deno
